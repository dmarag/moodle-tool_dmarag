...
function get_tool_dmarag_table_data_for_ws($courseid)
{
    global $DB;
    ...
    foreach ($records as $record)
    {
        ...
        $data[] = array('id'=>$id, 'name'=>$name, 'description'=>$description, 'completed'=>$completed, 'priority'=>$priority, 'timecreated'=>$timecreated, 'timemodified'=>$timemodified, 'delete'=>$delete);
